...
class DiegoWTsStarterSelection
  def initialize(pkmn1,pkmn2,pkmn3)
    ...
    if StarterSelSettings::INSTYLE == 2 # Set up graphics' style to match BW or HGSS style
      @sprites["starterbg"].setBitmap("Graphics/UI/DiegoWT's Starter Selection/starterbg_custom")
      @sprites["starterbg"].color = Color.new(255,255,255,105)
    else
      @sprites["starterbg"].setBitmap("Graphics/UI/DiegoWT's Starter Selection/starterbg")
    end
    ...
    if StarterSelSettings::TYPE2COLOR # Set up graphics for the background to match with the type color
      ...
      @sprites["typebg"].setBitmap("Graphics/UI/DiegoWT's Starter Selection/starterbg_custom") if StarterSelSettings::INSTYLE == 2
      @sprites["typebg"].setBitmap("Graphics/UI/DiegoWT's Starter Selection/starterbg")        if StarterSelSettings::INSTYLE == 1
    ...
    @sprites["base"].setBitmap("Graphics/UI/DiegoWT's Starter Selection/base")
    ...
    for i in 1..3
      @sprites["shadow_#{i}"].setBitmap("Graphics/UI/DiegoWT's Starter Selection/shadow")
