...
class PokemonPauseMenu_Scene
  ...
  def pbStartScene
    ...
    @sprites["background"].bitmap.blt(0, 0, pbBitmap("Graphics/UI/PauseMenu/bg"),Rect.new(0, 0, Graphics.width, Graphics.height))
    bmp = pbBitmap("Graphics/UI/Common/scrollbar_bg")
    ...
    @sprites["panorama"].setBitmap("Graphics/UI/Common/panorama")
    ...
    bmp = pbBitmap("Graphics/UI/Common/partyBar")
    content = []
    text = []
    if pbInSafari?
  ...
  def refresh
    ...
    bmp = pbBitmap("Graphics/UI/PauseMenu/sel")
    for i in 0...@entries.length
      key = @entries[i]
    ...
    bmp = pbBitmap("Graphics/UI/Common/scrollbar_kn")
