class AchievementButton < SpriteWrapper
  ...
  def initialize(x,y,name="",level="",internal="",viewport=nil)
    ...
    if currgoal
      @button=AnimatedBitmap.new("Graphics/UI/Achievements/achievementsButton")
    else
      @button=AnimatedBitmap.new("Graphics/UI/Achievements/completedButton")
    end
...
class AchievementText < SpriteWrapper
  ...
  def initialize(x,y,description="",progress="",viewport=nil)
    ...
    @progress=progress
    @button=AnimatedBitmap.new("Graphics/UI/Achievements/achievementsText")
