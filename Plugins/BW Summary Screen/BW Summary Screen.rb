  ...
  class MoveSelectionSprite < Sprite
    ...
    def initialize(viewport = nil, fifthmove = false)
      ...
      if SUMMARY_B2W2_STYLE
        @movesel = AnimatedBitmap.new("Graphics/UI/Summary/cursor_move_B2W2")
      else
  ...
  class RibbonSelectionSprite < MoveSelectionSprite
    def initialize(viewport = nil)
      ...
      if SUMMARY_B2W2_STYLE
        @movesel = AnimatedBitmap.new("Graphics/UI/Summary/cursor_ribbon_B2W2")
      else
  ...
  class PokemonSummary_Scene
    ...
    def pbStartScene(party, partyindex, inbattle = false)
      ...
      @sprites["downarrow"] = AnimatedSprite.new("Graphics/UI/downarrow",8, 28, 40, 2, @viewport)
      # Draws the Up Arrow in Ribbons Page
      ...
      if SUMMARY_B2W2_STYLE
        @sprites["markingsel"].setBitmap("Graphics/UI/Summary/cursor_marking_B2W2")
      else
  ...
  #===============================================================================
    def pbDisplayIVRating
      ratingf  = sprintf("Graphics/UI/Summary/RatingF")
      ratingd  = sprintf("Graphics/UI/Summary/RatingD")
      ratingc  = sprintf("Graphics/UI/Summary/RatingC")
      ratingb  = sprintf("Graphics/UI/Summary/RatingB")
      ratinga  = sprintf("Graphics/UI/Summary/RatingA")
      ratings  = sprintf("Graphics/UI/Summary/RatingS")
  ...
  #=============================================================================
    ...
    def drawPage(page)
      ...
      if SUMMARY_B2W2_STYLE
        @sprites["bg_overlay"].setBitmap("Graphics/UI/Summary/background_B2W2")
        @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_#{page}_B2W2")
      else
        @sprites["bg_overlay"].setBitmap("Graphics/UI/Summary/background")
        @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_#{page}")
      end
      imagepos = []
      ...
      status -= 1
      if status >= 0
        imagepos.push(["Graphics/UI/statuses", 410, 88, 0, 16 * status, 44, 16])
      end
      # Show Pokérus cured icon
      if @pokemon.pokerusStage == 2
        if SUMMARY_B2W2_STYLE
          imagepos.push([sprintf("Graphics/UI/Summary/icon_pokerus"), 376, 303])
        else
          imagepos.push([sprintf("Graphics/UI/Summary/icon_pokerus"), 376, 305])
        end
      end
      # Show shininess star
      if @pokemon.shiny?
        if SUMMARY_B2W2_STYLE
          imagepos.push([sprintf("Graphics/UI/shiny"), 350, 303])
        else
          imagepos.push([sprintf("Graphics/UI/shiny"), 350, 306])
        end
      end
      # Draw all images
      pbDrawImagePositions(overlay,imagepos)
    ...
    def drawPageOne
      ...
      if @pokemon.shadowPokemon?
        ...
        if SUMMARY_B2W2_STYLE
          imagepos = [
            ["Graphics/UI/Summary/overlay_shadow_B2W2",0, 228],
            ["Graphics/UI/Summary/overlay_shadowbar", 90, 266, 0, 0,(shadowfract * 248).floor, -1]
          ]
        else
          imagepos = [
            ["Graphics/UI/Summary/overlay_shadow", 0, 228],
            ["Graphics/UI/Summary/overlay_shadowbar", 90, 268, 0, 0,(shadowfract * 248).floor, -1]
          ]
        end
      ...
      if @pokemon.level < GameData::GrowthRate.max_level
        ...
        w = ((w/2).round) * 2
        if SUMMARY_B2W2_STYLE
          pbDrawImagePositions(overlay, [["Graphics/UI/Summary/overlay_exp", 140, 358 ,0, 0, w, 6]])
        else
          pbDrawImagePositions(overlay, [["Graphics/UI/Summary/overlay_exp", 140, 360, 0, 0, w, 6]])
        end
      end
    end
    ...
    def drawPageOneEgg
      ...
      if SUMMARY_B2W2_STYLE
        @sprites["bg_overlay"].setBitmap("Graphics/UI/Summary/background")
        @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_egg_B2W2")
      else
        @sprites["bg_overlay"].setBitmap("Graphics/UI/Summary/background")
        @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_egg")
      end
      imagepos = []
      # Show the Poké Ball containing the Pokémon
      ballimage = sprintf("Graphics/UI/Summary/icon_ball_%s", @pokemon.poke_ball)
    ...
    def drawPageThree
      ...
      if SHOW_EV_IV
        ...
        @sprites["bg_overlay"].setBitmap("Graphics/UI/Summary/background")
        @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_hidden")
      end

      if SHOW_EV_IV && SUMMARY_B2W2_STYLE
        # Set background image when showing EV/IV Stats
        @sprites["bg_overlay"].setBitmap("Graphics/UI/Summary/background_B2W2")
        @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_hidden_B2W2")
      end
  ...
  # Write various bits of text
      ...
      if @pokemon.hp > 0
        ...
        if SHOW_EV_IV
          imagepos = [["Graphics/UI/Summary/overlay_hp", 190, 112, 0, hpzone * 6, w, 6]]
        else
          imagepos = [["Graphics/UI/Summary/overlay_hp", 168, 112, 0, hpzone * 6, w, 6]]
        end
        pbDrawImagePositions(overlay, imagepos)
      end
    end
    ...
    def drawPageFour
      ...
      Pokemon::MAX_MOVES.times do |i|
        ...
        if move
          ...
          imagepos.push(["Graphics/UI/types", 32, yPos + 8, 0, type_number * 28, 64, 28])
    ...
    def drawPageFourSelecting(move_to_learn)
      ...
      # Set background image
      if move_to_learn
        @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_learnmove")
      else
        if SUMMARY_B2W2_STYLE
          @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_movedetail_B2W2")
        else
          @sprites["menuoverlay"].setBitmap("Graphics/UI/Summary/bg_movedetail")
        end
      end
      # Write various bits of text
      ...
      limit.times do |i|
        ...
        if move
          type_number = GameData::Type.get(move.display_type(@pokemon)).icon_position
          imagepos.push(["Graphics/UI/types", 260, yPos + 8, 0, type_number * 28, 64, 28])
    ...
    def drawSelectedMove(move_to_learn, selected_move)
      ...
      imagepos = [["Graphics/UI/category", 166, 122, 0, selected_move.display_category(@pokemon) * 28, 64, 28]]
      pbDrawImagePositions(overlay, imagepos)
    ...
    def drawPageFive
      ...
      (@ribbonOffset * 4...(@ribbonOffset * 4) + 12).each do |i|
        ...
        imagepos.push(["Graphics/UI/ribbons",
    ...
    def drawSelectedRibbon(ribbonid)
      ...
      if SUMMARY_B2W2_STYLE
        imagepos = [["Graphics/UI/Summary/overlay_ribbon_B2W2", 0, 280]]
      else
        imagepos = [["Graphics/UI/Summary/overlay_ribbon", 0, 280]]
      end
      pbDrawImagePositions(overlay, imagepos)
